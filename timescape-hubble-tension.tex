...
dynamical spatial curvature has already been fit jointly to supernovae, the CMB, and BAO
\cite{Desgrange2019} and found statistically indistinguishable from $\Lcdm$ on the
supernova data---an early multi-probe test of a non-timescape backreaction model, and a
precedent for the same-footing comparison we pursue here. Whether backreaction
...
assumptions~\cite{OstrowskiRoukema2015}, contend their scheme misses the non-local
averaging effects that matter. The dispute is partly one of gauge: spatial averaging
