...
minimum is $\approx1.8\times$ the Gaussian expectation and the $\sqrt{\Delta\chi^2}$
...
$\sim1.2\sigma$ if the external cosmology-independent anchor $\fvo=0.737$ is also
substituted (this last adopts an assumed $\pm0.02$ uncertainty on the anchored SN void
fraction; the published $\pm0.029$ is larger and lowers the figure slightly further, to
$\sim1.1$--$1.2\sigma$). Across the CMB-systematic-free, non-anchor subgrid (the paper's
...
verdict~\cite{DiValentino2021}, metric-based rankings find late-Universe and
local mechanisms cannot resolve $\Ho$ under joint BAO$+$SN constraints
\cite{Schoneberg2022}, and the community CosmoVerse review---co-authored by
timescape proponents---likewise catalogues the inhomogeneity class among the more
weakly supported options while calling for systematics-controlled tests
\cite{CosmoVerse2025}.
